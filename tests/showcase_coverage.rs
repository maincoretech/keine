...
fn action_name(action: &Action) -> &'static str {
    match action {
        ...
        Action::ConfigureSpriteSequence { .. } => "configure-sprite-sequence",
        Action::SelectTextPresentation { .. } => "select-text-presentation",
        Action::ConfigureFloatingText { .. } => "configure-floating-text",
        Action::Say { .. } => "say",
        Action::Menu { .. } => "menu",
        Action::Jump(_) => "jump",
