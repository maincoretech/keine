# LetsGal 1.11.0 回归工程分步验收

## 0. 启动

1. 运行 `cargo validate tests/fixtures/letsgal-timeline`，应报告工程有效且无错误。
2. 运行 `cargo dev tests/fixtures/letsgal-timeline`，应进入 `Kēne LetsGal 1.11.0 Timeline Lab` 标题页。
